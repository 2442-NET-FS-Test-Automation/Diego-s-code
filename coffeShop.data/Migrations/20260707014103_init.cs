    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Name", "Price", "Sku" },
                values: new object[,]
                {
                    { 1, "American", 50.00m, "HOT-AME-01" },
                    { 2, "Latte", 65.00m, "HOT-LAT-02" },
                    { 3, "Capuccino", 60.00m, "HOT-CAP-03" },
                    { 4, "Taro", 80.00m, "HOT-TAR-04" },
                    { 5, "Natural Chai", 90.00m, "HOT-CHA-05" },
                    { 6, "Iced Latte", 70.00m, "COL-LAT-06" },
                    { 7, "Iced American", 60.00m, "COL-AME-07" },
                    { 8, "Iced Taro", 85.00m, "COL-TAR-08" },
